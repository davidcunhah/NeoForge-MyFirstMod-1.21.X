...
public class ModCreativeModeTabs {
    ...
    public static final Supplier<CreativeModeTab> BISMUTH_ITEMS_TAB = CREATIVE_MODE_TAB.register("bismuth_items_tab",
            () -> CreativeModeTab.builder()
                    .icon(
                            () -> new ItemStack(ModItems.AMONG_US.get()))
                    .title(Component.translatable("creativetab.myfirstmod.bismuth_items"))
    ...
    public static final Supplier<CreativeModeTab> BISMUTH_BLOCKS_TAB = CREATIVE_MODE_TAB.register("bismuth_blocks_tab",
            () -> CreativeModeTab.builder()
                    .icon(
                            () -> new ItemStack(ModBlocks.BISMUTH_BLOCK.get()))
                    .withTabsBefore(ResourceLocation.fromNamespaceAndPath(MyFirstMod.MOD_ID, "bismuth_items_tab"))
                    .title(Component.translatable("creativetab.myfirstmod.bismuth_blocks"))
                    .displayItems((itemDisplayParameters, output) -> {
